	...
	<body>
		...
		$(document).ready(function() {
			...
			$("#btn-add").click(function() {
				var url = "${ctx}/manage/house/add?random=" + Math.random();
				var options = {
					title: '新增',
					width: 500
				};
		...
		*/
		...
		function doSearch() {
			...
			$("#dataGridTable").jqGrid("setGridParam", {
				url : "${ctx}/manage/house/query?random="+ Math.random(),
				page : page,
				postData : {
		...
		function doModify(id) {
			var url = "${ctx}/manage/house/edit?id=" + id + "&random=" + Math.random();
			var options = {
				title: '编辑',
				width: 500
			};
		...
		function doTrash(id) {
			dialog({
			    ...
			    ok: function () {
			        this.title('删除中…');
			        var url = "${ctx}/manage/house/delete?random="+ Math.random();
					var params = {
						id: id
					};
